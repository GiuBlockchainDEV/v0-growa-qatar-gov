...
const FEED_ITEMS: FeedItem[] = [
  {
    ...
    sourceUrl:
      'https://thepeninsulaqatar.com/article/17/06/2026/date-palm-farmers-urged-to-maintain-harvest-hygiene-monitor-infestations',
    category: 'policy',
  ...
  {
    id: 'rss-2',
    title: 'Qatar pivots to private sector model for long-term food security',
    summary:
      'IFC and USQBC Doha launched an agrifood investment roadmap aligned with Qatar National Food Security Strategy 2030, shifting from government-to-government imports toward commercially resilient private-sector food systems.',
    source: 'Gulf Times',
    sourceUrl: 'https://www.gulf-times.com/article/727242/qatar/qatar-pivots-to-private-sector-for-food-security',
    category: 'policy',
  ...
  {
    id: 'rss-3',
    title: 'Peak summer advisory: limit outdoor farm work and protect greenhouse cooling systems',
    summary:
      'Qatar enters peak June heat with daytime highs above 40°C and minimal rainfall. Farm operators should schedule field work before 10:00, service pad-and-fan systems, and increase hydration protocols for outdoor crews.',
  ...
  {
    id: 'rss-4',
    title: 'Qatar developing national programme to reduce food waste and post-harvest losses',
    summary:
      'The Ministry of Municipality is advancing a comprehensive food loss and waste programme under the National Food Security Strategy 2030, supported by FAO and UNEP baseline assessments across the value chain.',
    source: 'The Peninsula Qatar',
    sourceUrl: 'https://thepeninsulaqatar.com/article/08/06/2026/qatar-developing-programme-for-reducing-food-waste',
    category: 'policy',
    publishedAt: '2026-06-08T10:15:00Z',
    region: 'Qatar',
  },
  {
    id: 'rss-5',
    title: 'GCC workshop advances AI and IoT for water-efficient farm management',
    summary:
      'A three-day Gulf workshop in Muscat examined a joint GCC-ICARDA project to deploy AI, IoT, and digital tools across date palm plantations, open-field crops, and protected agriculture in arid environments.',
    source: 'Muscat Daily',
  ...
  {
    id: 'rss-6',
    title: 'Hormuz shipping disruption raises fertilizer and staple food risk across the GCC',
    summary:
      'Analysts warn that strait closures are stalling fertilizer trade and disrupting maritime food imports, forcing GCC states to rely on strategic reserves, airfreight, and overland corridors to protect supply chains.',
    source: 'Arab News',
    sourceUrl: 'https://www.arabnews.com/node/2646309',
    category: 'market',
  ...
  {
    id: 'rss-7',
    title: 'Local vegetable output on track for 120,000 tonnes and 70% self-sufficiency in 2026',
    summary:
      'Qatar’s greenhouse and protected agriculture expansion is pushing domestic vegetable production higher, with the sector projected to reach around $200 million in market value by year-end.',
    source: 'The Peninsula Qatar',
    sourceUrl:
      'https://thepeninsulaqatar.com/article/26/03/2026/qatars-local-vegetable-production-to-reach-120000-tonnes-by-end-of-2026-achieving-70-self-sufficiency',
    category: 'market',
    publishedAt: '2026-06-06T07:45:00Z',
    region: 'Qatar',
  },
  {
    id: 'rss-8',
    title: 'Oman expands net-zero and smart agriculture initiatives across national farms',
    summary:
      'Oman is scaling hydroponics, vertical farming, drone monitoring, and IoT irrigation as part of 11 national agriculture projects aimed at cutting water, energy, and fertilizer use while strengthening food security.',
    source: 'Oman Observer',
    sourceUrl: 'https://www.omanobserver.om/article/1190918/oman/oman-advances-net-zero-drive-in-agriculture-sector',
    category: 'technology',
    publishedAt: '2026-06-08T17:16:00Z',
    region: 'GCC',
  },
]
